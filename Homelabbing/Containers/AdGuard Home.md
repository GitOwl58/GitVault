...
Network-wide ad and tracker blocking at the DNS level, the same core idea as **[[Pi-hole]]**: it acts as the network's DNS server and refuses to resolve known ad/tracking domains, blocking them for every device at once without per-device software.
